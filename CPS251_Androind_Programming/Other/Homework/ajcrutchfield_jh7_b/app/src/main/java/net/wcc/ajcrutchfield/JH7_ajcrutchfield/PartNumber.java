...
public class PartNumber {
    ...
    public PartNumber(String part, Context main, TableLayout table){
        ...
        partText.setOnLongClickListener((View.OnLongClickListener) main);
...
//        demandEdit.focusSearch(demandEdit.FOCUS_DOWN);
    ...
    public int getDemand(){
        ...
        try {
            ...
            Log.d("Mine", "NumberFormatException 'demand'");
        }
        return demand ;
    }
    ...
    public int getStandardCount(){
        ...
        int standardCount = 0;
        try {
            standardCount = Integer.parseInt(countStr);
        }
        catch(NumberFormatException e){
            Log.d("Mine", "NumberFormatException 'standardCount'");
        }
