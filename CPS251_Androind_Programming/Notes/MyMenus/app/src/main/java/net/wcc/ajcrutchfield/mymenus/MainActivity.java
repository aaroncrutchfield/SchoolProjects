package net.wcc.ajcrutchfield.mymenus;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //getOverflowMenu(); // Turn on the Samsung Hack to get the "three dots"
    }

    private void getOverflowMenu() {
       // This routing is a Hack that I used on my Samsung to get the "three dots" for the
       // overflow area.  My Samsung had a built in "Menu button" so it technically didn't need the
       // "three dots" overflow area. This is discussed in the last 4 minutes of the associated video.
