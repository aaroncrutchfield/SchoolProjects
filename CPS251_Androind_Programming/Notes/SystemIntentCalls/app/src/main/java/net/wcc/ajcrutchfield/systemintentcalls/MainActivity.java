package net.wcc.ajcrutchfield.systemintentcalls;
...
public class MainActivity extends Activity implements OnClickListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // For Android Studio, you may get a compile error on the previous statement
        // You may need the following instead for Android Studio
        //getMenuInflater().inflate(R.menu.main, menu);
        return true;
    }
    @Override
